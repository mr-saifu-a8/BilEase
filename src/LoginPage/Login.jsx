  ...
  return (
    <div className="w-full">
      <div className=" bg-white h-[100vh] lg:flex md:flex overflow-hidden">
        <div className="bg-black lg:rounded-br-[40%] h-45 lg:h-full lg:w-[50vw] md:h-full md:w-[50vw] flex flex-col items-center justify-center">
          ...
          <span className="text-white lg:text-8xl md:text-8xl text-7xl">
            <GoPerson />
          </span>
        </div>

        {/* Login content */}
        <div className="px-6 lg:w-[40vw] lg:absolute lg:right-20 lg:top-30 md:w-[50vw] pt-10 pb-8">
          <h1 className="text-3xl lg:text-5xl font-bold text-center mb-8">Login</h1>

          <label className="block text-sm lg:text-xl md:text-lg font-semibold mb-2">Email</label>
          <input
            type="email"
          ...
          <label className="block text-sm lg:text-xl md:text-lg font-semibold mb-2">Password</label>
          <input
            type="password"
            placeholder="**********"
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <span onClick={()=> navigate(`/signup`)} className="font-semibold text-black underline cursor-pointer">Sign Up</span>
          </div>
        </div>
      </div>
    </div>
